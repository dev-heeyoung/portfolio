          ...
          <div className="flex flex-col">
            ...
            <div className="relative w-full text-left z-20">
              <div className="w-full h-8 leading-6 relative flex items-center overflow-hidden">
                <div class="animate-textSlide absolute top-0 font-bold text-3xl p-0 uppercase text-point tracking-wide">
                  Heeyoung Yang
                  <br />
                  Web Developer
                  <br />
              ...
              <p className="mt-5">
                ...
                Officia quibusdam soluta quaerat corporis, vitae maxime vero,
                modi eius animi quos aliquid voluptas? Ipsa nobis, numquam quis
                aliquid enim pariatur voluptates.
              </p>
            </div>
          </div>
        </div>
